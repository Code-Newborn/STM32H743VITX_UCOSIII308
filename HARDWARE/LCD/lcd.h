...
//-----------------MCU屏 LCD端口定义----------------
// LCD背光	PB5
#define LCD_LED_ON  HAL_GPIO_WritePin( ILI_CTR_GPIO_Port, ILI_CTR_Pin, GPIO_PIN_SET )
#define LCD_LED_OFF HAL_GPIO_WritePin( ILI_CTR_GPIO_Port, ILI_CTR_Pin, GPIO_PIN_RESET )
// LCD地址结构体
typedef struct {
